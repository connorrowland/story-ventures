...
import LivezLogo from "../Images/LivezLogo.png";
import PolymerLogo from "../Images/PolymerLogo.png";
...
export default () => (
  <div id="landing-page">
    <Helmet>
      <meta
        name="description"
        content="The future of data automation is unwritten. We back the authors."
      ></meta>
    </Helmet>
        ...
        <div className="col-md-12 col-sm-12 col-xs-12">
          <div className="landing-header--inner">
            <h1 id="landing-header--future-heading-one">
              The future of{" "}
              <br className="landing-future-heading--mobile-break" />
              <ScrollToAnchorLink
                anchor="#landing--trio"
          ...
          <div id="landing-header--illo-container">
            <div id="landing-header-illo--inner">
              <img
                src={InfrastructureIllo}
                alt="Story Illustration"
                className="landing-header--illo"
              />
              <img
                src={SensorySystemsIllo}
                alt="Story Illustration"
                className="landing-header--illo"
              />
              <img
    ...
    <section id="landing--approach" className="thirds--section">
      ...
      >
        ...
        <div
          ...
          id="approach--text"
        >
          <h6 className="eyebrow thirds-section--eyebrow">
            A full-stack approach
          </h6>
          <h4 className="thirds-section--heading long-form--thirds-header">
            We invest in the building blocks of automated systems—starting with
    ...
    <section id="landing--trio">
      <div className="landing-trio--inner">
        <div className="landing-trio--item">
          <div className="landing-trio--illo-container">
            <img
              src={InfrastructureIllo}
              alt="Story Illustration"
              className="landing-trio--illo"
            />
          </div>
          <h5 className="landing-trio--heading">Sensory Systems</h5>
          <p className="landing-trio--sub-heading">
            Systems that capture and understand real world data.
          </p>
          <div className="landing-trio--attributes">
            <h6 className="landing-trio-attributes--heading">INCLUDES</h6>
            <p className="landing-trio-attributes--subheading">
              Autonomous vehicles
              <br className="hide-for-mobile" />
              <span className="show-for-mobile">,</span> Data capture
              <br className="hide-for-mobile" />
              <span className="show-for-mobile">,</span> Robotics{" "}
            </p>
          </div>
        </div>
        ...
        <div className="landing-trio--item">
          ...
          <p className="landing-trio--sub-heading">
            Systems that process, organize, and store data.
          </p>
          <div className="landing-trio--attributes">
            <h6 className="landing-trio-attributes--heading">INCLUDES</h6>
            <p className="landing-trio-attributes--subheading">
              Data cleansing
              <br className="hide-for-mobile" />
              <span className="show-for-mobile">,</span> Data aggregation
              <br className="hide-for-mobile" />
              <span className="show-for-mobile">,</span> Sensor fusion
            </p>
          </div>
        </div>
        <div className="section--divider"></div>
        <div className="landing-trio--item">
          ...
          <p className="landing-trio--sub-heading">
            Systems that utilize and apply intelligence to data.
          </p>
          <div className="landing-trio--attributes">
            <h6 className="landing-trio-attributes--heading">INCLUDES</h6>
            <p className="landing-trio-attributes--subheading">
              Computer vision
              <br className="hide-for-mobile" />
              <span className="show-for-mobile">,</span> Machine learning
              <br className="hide-for-mobile" />
              <span className="show-for-mobile">,</span> Natural language{" "}
            </p>
          </div>
        </div>
      </div>
    ...
    <section id="landing--portfolio-grid">
      <div id="portfolio-grid--inner">
        ...
        />
        <PortfolioItem
          logo={AwareHealthcareLogo}
          companyName="Aware Healthcare"
          companyBio="Leveraging alternative data to improve mental health."
          link="https://www.awarehc.com/"
        />
        <PortfolioItem
          logo={AetherLogo}
          companyName="Aether Biomedical"
          companyBio="Developing cutting edge prosthetic and rehabilitation devices through biosignal processing."
          link="https://aetherbiomedical.com/"
          id="Aether-Logo"
        />
        <PortfolioItem
          logo={PolymerLogo}
          companyName="Polymer"
          companyBio="Automating prevention and remediation of sensitive customer data leakage."
          link="https://www.polymerhq.io/"
        />
        <PortfolioItem
          logo={DelfinaLogo}
          companyName="Delfina"
      ...
      <div className="thirds-section--inner">
        <div className="thirds-section--first" id="statement--gray-box">
          <img
            src={Logo}
            alt="Story Logo"
            className="landing-statement--logo"
          />
        </div>
        <div className="thirds-section--second" id="statement--text">
          ...
          <h4 className="thirds-section--heading long-form--thirds-header">
            We support founders from the very beginning, emphasizing people and
            vision over everything else.
          </h4>
        </div>
      </div>
    </section>
      ...
      <div id="founders--inner">
        <div className="founder-container">
          ...
          <p className="founder--bio">
            {" "}
            Focuses on the messy middle of making data usable, as well as the
            impact of design on human-technology interactions. Jake is a former
            lawyer who leverages his legal and regulatory experience to help
            companies navigate the complex data ecosystem.
          </p>
        </div>
        <div className="section--divider"></div>
        <div className="founder-container">
          ...
          <p className="founder--bio">
            Focuses on the integration of hardware and software, as well as new
            forms of data capture and processing. Brian specializes in mobility
            investing, with an interest in everything that touches logistics and
